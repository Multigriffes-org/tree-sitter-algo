...
export default grammar({
  ...
  rules: {
    ...
    type_definition: ($) => seq(":", $.type),
    output_type: ($) => seq("->", $.type),

    vocabulary: ($) => seq($.vocab_keyword, ":", repeat($._declaration)),
    vocab_keyword: () => choice("Lexique", "lexique"),
    ...
    algorithme_keyword: () => choice("Algorithme", "algorithme"),
    algorithme_boundary: ($) =>
